import { Alert, Button, Modal, ModalBody, Progress, TextInput } from 'flowbite-react'
...
export default function DashProfile() {
  ...
  const uploadImage = async () => {
    ...
    //method to get info while the img is getting uploaded
    ...
    uploadeTask.on(
      ...
      (error) => {
        setImageFileUploadingError('Could not Upload Image (Check File Type = .img & File Size < 2MB)');
        ...
        <Modal.Header/>
          <Modal.Body>
            <div className="text-center">
              <HiOutlineExclamationCircle className='h-14 w-14 text-grey-400 dark: text-red-400 mb-4 mx-auto'/>
